...
\begin{foldedframe}[Windows (AppsAnywhere --- easiest)]
  \textcolor{red}{\textbf{Changed on January 2026.}} Due to an unresolved issue with CloudPaging Player, the instructions below are a little different now.
  \begin{itemize}
...
winget install mutool
      \end{lstlisting}
    \item Open a terminal, or StrawberryPerl, and run:
      \begin{lstlisting}
llw32helper.bat
      \end{lstlisting}
