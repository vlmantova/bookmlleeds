...
\lstdefinestyle{latexml}{language=[LaTeX]TeX,%
  ...
  moretexcs=[2]{LaTeXML,iflatexml,lxHTML,lxAddClass,lxWithClass,lxBeginTableHead,lxEndTableHead,lxFcn,lxID,lxPunct,lxContextTOC,lxNavbar,lxHeader,lxFooter}%
  }
